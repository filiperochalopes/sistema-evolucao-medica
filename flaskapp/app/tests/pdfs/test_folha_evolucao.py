...
from app.tests.pdfs.request_queries_examples import (
    folha_evolucao_request_strings
)
...
def test_create_pdf_file_from_queries(client):
    ...
    for request_string in folha_evolucao_request_strings:
        ...
        generated_pdf_b64 = b64decode(result["generatePdf_FolhaEvolucao"]["base64Pdf"], validate=True)
