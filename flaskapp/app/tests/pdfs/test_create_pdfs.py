...
import pytest
from app.tests.pdfs.request_queries_examples import  prescricao_medica_request_string, lme_request_string, solicit_mamografia_request_string, relatorio_alta_request_string,  lme_required_data_request_string,relatorio_alta_required_data_request_string,solicit_mamografia_required_data_request_string

@pytest.mark.parametrize("request_string", [prescricao_medica_request_string, lme_request_string, solicit_mamografia_request_string, relatorio_alta_request_string, lme_required_data_request_string,relatorio_alta_required_data_request_string,solicit_mamografia_required_data_request_string])
