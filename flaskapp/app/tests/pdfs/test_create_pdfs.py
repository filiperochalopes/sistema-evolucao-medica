...
import pytest
from app.tests.pdfs.request_queries_examples import aih_sus_request_string, exam_request_request_string, ficha_internamento_request_string, prescricao_medica_request_string, lme_request_string, solicit_mamografia_request_string, relatorio_alta_request_string, exam_request_2_pages_request_string, exam_request_3_pages_request_string, folha_prescricao_request_string, folha_evolucao_request_string, balanco_hidrico_request_string,exam_request_required_data_request_string,ficha_internamento_required_data_request_string,aih_sus_required_data_request_string,lme_required_data_request_string,relatorio_alta_required_data_request_string,solicit_mamografia_required_data_request_string

@pytest.mark.parametrize("request_string", [aih_sus_request_string, exam_request_request_string, ficha_internamento_request_string, prescricao_medica_request_string, lme_request_string, solicit_mamografia_request_string, relatorio_alta_request_string, exam_request_2_pages_request_string, exam_request_3_pages_request_string, folha_prescricao_request_string, folha_evolucao_request_string, balanco_hidrico_request_string,exam_request_required_data_request_string,ficha_internamento_required_data_request_string,aih_sus_required_data_request_string,lme_required_data_request_string,relatorio_alta_required_data_request_string,solicit_mamografia_required_data_request_string])
