...
from app.env import GRAPHQL_MUTATION_QUERY_URL, WRITE_DECODE_AIH_SUS_DIRECTORY, WRITE_DECODE_APAC_DIRECTORY,WRITE_DECODE_EXAM_REQUEST_DIRECTORY,WRITE_DECODE_FICHA_INTERN_DIRECTORY, WRITE_DECODE_LME_DIRECTORY, WRITE_DECODE_PRESCRICAO_MEDICA_DIRECTORY, WRITE_DECODE_RELATORIO_ALTA_DIRECTORY, WRITE_DECODE_SOLICIT_MAMOGRAFIA_DIRECTORY, WRITE_DECODE_COMPACTED_DIRECTORY,WRITE_DECODE_EXAM_REQUEST_2_PAGES_DIRECTORY, WRITE_DECODE_EXAM_REQUEST_3_PAGES_DIRECTORY, WRITE_DECODE_FOLHA_PRESCRICAO_DIRECTORY, WRITE_DECODE_FOLHA_EVOLUCAO_DIRECTORY,WRITE_DECODE_APAC_REQUIRED_DATA_DIRECTORY,WRITE_DECODE_EXAM_REQUEST_REQUIRED_DATA_DIRECTORY,WRITE_DECODE_FICHA_INTERN_REQUIRED_DATA_DIRECTORY,WRITE_DECODE_AIH_SUS_REQUIRED_DATA_DIRECTORY,WRITE_DECODE_LME_REQUIRED_DATA_DIRECTORY, WRITE_DECODE_RELATORIO_ALTA_REQUIRED_DATA_DIRECTORY, WRITE_DECODE_SOLICIT_MAMOGRAFIA_REQUIRED_DATA

import pytest
from app.tests.pdfs.request_queries_examples import exam_request_request_string, ficha_internamento_request_string, prescricao_medica_request_string, lme_request_string, solicit_mamografia_request_string, relatorio_alta_request_string, exam_request_2_pages_request_string, exam_request_3_pages_request_string, folha_prescricao_request_string, folha_evolucao_request_string,exam_request_required_data_request_string,ficha_internamento_required_data_request_string,lme_required_data_request_string,relatorio_alta_required_data_request_string,solicit_mamografia_required_data_request_string

@pytest.mark.parametrize("request_string", [exam_request_request_string, ficha_internamento_request_string, prescricao_medica_request_string, lme_request_string, solicit_mamografia_request_string, relatorio_alta_request_string, exam_request_2_pages_request_string, exam_request_3_pages_request_string, folha_prescricao_request_string, folha_evolucao_request_string, exam_request_required_data_request_string,ficha_internamento_required_data_request_string,lme_required_data_request_string,relatorio_alta_required_data_request_string,solicit_mamografia_required_data_request_string])
