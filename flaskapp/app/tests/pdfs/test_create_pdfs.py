...
(folha_prescricao_request_string, WRITE_DECODE_FOLHA_PRESCRICAO_DIRECTORY, "generatePdf_FolhaPrescricao"), (folha_evolucao_request_string, WRITE_DECODE_FOLHA_EVOLUCAO_DIRECTORY, "generatePdf_FolhaEvolucao")])
