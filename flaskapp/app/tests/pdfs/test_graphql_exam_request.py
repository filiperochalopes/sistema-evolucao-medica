...
def test_empty_value_prof_authorized_name(test_input):
    assert data_to_use(prof_authorized_name=test_input) == True

@pytest.mark.parametrize("test_input", ['    ', ''])
def test_empty_value_document_pacient_name(test_input):
    assert data_to_use(document_pacient_name=test_input) == True
