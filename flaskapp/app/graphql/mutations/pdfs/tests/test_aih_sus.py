...
def data_to_use(establishment_solitc_name='Establishment Solicit Name',
    ...
    pension_status='not_insured'):
        return pdf_aih_sus.fill_pdf_aih_sus(
...
def test_solicitDoc_invalidCNS():
    ...
    assert pdf_aih_sus.fill_pdf_aih_sus(
        ...
        clinic='Clinic Name', 
        internation_carater='Internation Carater', 
        prof_solicitant_document={'CNS':5641654864983},
        prof_solicitant_name='Profissional Solicit Name', 
        solicitation_datetime=datetime.datetime.now(), 
        autorization_prof_name='Autorization professional name', 
        emission_org_code='OrgCode2022', 
        ...
        company_cnae=5310501, 
        company_cbor=123456, 
        pension_status='not_insured').status == Response(status=400).status
...
def test_autorization_invalidCNS():
    ...
    assert pdf_aih_sus.fill_pdf_aih_sus(
        ...
        autorization_prof_name='Autorization professional name', 
        emission_org_code='OrgCode2022', 
        autorizaton_prof_document={'CNS':54894131597474}, 
        autorizaton_datetime=datetime.datetime.now(),
        hospitalization_autorization_number=1234567890,
        exam_results='Xray tibia broken',
        chart_number=1234,
