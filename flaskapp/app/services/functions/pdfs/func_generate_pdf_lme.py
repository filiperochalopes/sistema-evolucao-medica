...
def func_generate_pdf_lme(requesting_establishment:dict, patient:dict, patient_height:int, cid_10:str, anamnese:str, requesting_professional_name:str, solicitation_date:datetime.datetime, requesting_professional_document:dict, capacity_attest:list, filled_by:list, patient_ethnicity:list, previous_treatment:list, diagnostic:str=None, patient_email:str=None, contacts_phonenumbers:list=None, medicines:list=None) -> str:
    ...
    try:
        ...
        try:
            pdf.add_oneline_text(text=requesting_establishment['cnes'], pos=(38, 658), field_name='Establishment Solict CNES', len_max=7, len_min=7,interval='   ')
            patient_weight = int(patient['weight_kg'])
            pdf.add_oneline_intnumber(number=patient_weight, pos=(485, 628), field_name='Patient Weight', len_max=3, len_min=1,value_min=1, value_max=999, interval='   ')
            pdf.add_oneline_intnumber(number=patient_height, pos=(485, 602), field_name='Patient Height', len_max=3, len_min=1,value_min=1, value_max=999, interval='   ')
            pdf.add_oneline_text(text=cid_10, pos=(34, 455), field_name='cid_10', len_max=4, len_min=3, interval='  ')
            pdf.add_datetime(date=solicitation_date, pos=(292, 222), field_name='Solicitation Datetime', hours=False, interval='   ', formated=False)
            pdf.add_document_cns_cpf_rg(document=requesting_professional_document, pos_square_cpf=(41, 195), pos_square_cns=(84,194), pos_cns=(129, 195), pos_cpf=(129, 195),field_name='Professional Solicitor Document', interval='  ', square_size=(5, 8))


            pdf.set_font('Roboto-Mono', 9)
            pdf.add_oneline_text(text=requesting_establishment['name'], pos=(206, 658), field_name='Establishment Solicit Name', len_max=65, len_min=8)
            pdf.add_oneline_text(text=patient['name'], pos=(36, 628), field_name='Patient Name', len_max=79, len_min=7)
            pdf.add_oneline_text(text=patient['mother_name'], pos=(36, 602), field_name='Patient Mother Name', len_max=79, len_min=7)
            pdf.add_morelines_text(text=anamnese, initial_pos=(36, 430), decrease_ypos= 10, field_name='Anamnese', len_max=485, char_per_lines=97, len_min=5)
            pdf.add_oneline_text(text=requesting_professional_name, pos=(36, 224), field_name='Professional Solicitor Name', len_max=45, len_min=8)
            ...
            pdf.add_markable_square_and_onelinetext(option=capacity_attest[0], valid_options=['SIM','NAO'], text_options=['SIM'], text_pos=(308, 268), options_positions=((79, 271), (42,270)), field_name='Capacity Attest', len_max=46, text=capacity_attest[1], len_min=5, square_size=(5, 8))
            ...
            pdf.add_markable_square_and_onelinetext(option=patient_ethnicity[0], valid_options=['BRANCA','PRETA', 'PARDA', 'AMARELA', 'INDIGENA', 'SEMINFO', 'INFORMAR'], text_options=['INFORMAR'], text_pos=(192, 108), options_positions=((40, 121), (40, 108),(40, 93),(94, 118), (94, 106),(94, 93), (94, 93)),field_name='Patietn Ethinicity', len_max=31, text=patient_ethnicity[1], len_min=4, square_size=(5, 8))
            ...
            pdf.add_markable_square_and_morelinestext(option=previous_treatment[0], valid_options=['SIM','NAO'],text_options=['SIM'], text_pos=(100, 355), options_positions=((40, 355), (40, 337)), field_name='Previous Treatment', len_max=170, text=previous_treatment[1], len_min=4, square_size=(5, 8),char_per_lines=85, decrease_ypos=15)
        ...
        try:
            ...
            pdf.add_oneline_text(text=diagnostic, pos=(105, 455), field_name='Diagnostic', len_max=84, len_min=4, nullable=True)
            pdf.add_oneline_text(text=patient_email, pos=(36, 42), field_name='Patient Email', len_max=62, len_min=8, nullable=True)
