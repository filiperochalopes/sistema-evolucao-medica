...
def func_generate_pdf_prescricao_medica(document_date:str, patient:dict, professional:dict, prescription:list) -> str:
    """fill pdf prescricao medica with 2 pages 

    Args:
        document_date (str): document_date in %d/%m/%Y %H:%M format
