...
def func_generate_pdf_evol_compact(
    ...
    try:
        ...
        try:
            ...
            document_date = pdf.add_datetime(
            ...
            pdf.add_datetime(
                date=admission_history["created_at"],
                pos=(408, 515),
            ...
            internment_day = (document_date.date() - isoparse(admission_history["created_at"]).date()).days
